...
@section('tittle', 'View Users - petugas')
            ...
            <div class="page-header">
                ...
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/home" class="breadcrumb-link">Users</a></li>
                                ...
                                @foreach ($petugas as $ptg)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="delete-petugas/{{ $ptg->id }}" class="btn btn-sm btn-danger mt-1">hapus</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
