...
@section('tittle', 'Update My Profile')
@section('content')
    <!-- ============================================================== -->
    <!-- pageheader  -->
    <!-- ============================================================== -->
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <h5 class="card-header">Update Data User</h5>
                <div class="card-body">
                    ...
                    @endif
                    @foreach ($user as $usr)
                        <form method="POST" action="/update-account/{{ $usr->id }}">
                            @csrf
                            <div class="">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form-control-lg" id="name" type="text"
                                            ...
                                            autofocus placeholder="Username" value="{{ $usr->name }}">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form-control-lg" id="address" type="text"
                                            ...
                                            required autofocus placeholder="Address" value="{{ $usr->address }}">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form-control-lg" id="phone" type="text"
                                            ...
                                            autocomplete="off" autofocus placeholder="phone" value="{{ $usr->phone }}">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control form-control-lg" id="email" type="email"
                                            ...
                                            autocomplete="off" placeholder="Email" value="{{ $usr->email }}">
                                    ...
                                    <div class="form-group pt-2">
                                        <button class="btn btn-block btn-primary" type="submit">Update My Account</button>
                                    </div>
                                </div>
                            </div>
                        </form>
